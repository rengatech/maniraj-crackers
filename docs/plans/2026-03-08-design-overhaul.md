...
<head>
    ...
    <title>Maniraj Crackers - Best crackers @ affordable price</title>
        ...
        <div class="mx-auto max-w-6xl px-4">
            <div class="flex h-16 items-center justify-between">
                ...
                <Link href="/" class="flex items-center gap-2">
                    <img src="/assets/img/MADHU.svg" alt="Manira Crackers" class="h-10 w-auto" />
    ...
    <footer class="bg-brand-dark text-gray-300">
        ...
        <div class="border-t border-gray-700 py-4">
            <p class="text-center text-xs text-gray-500">
                &copy; {{ new Date().getFullYear() }} Maniraj Crackers. All rights reserved.
            </p>
        </div>
    </footer>
</template>
            ...
            <div v-for="about in about_page" :key="about.id" class="mb-12">
                <div class="grid gap-8 lg:grid-cols-2">
                    ...
                    <div class="overflow-hidden rounded-xl">
                        <img src="/assets/img/page-3.jpeg" alt="Maniraj Crackers" class="h-full w-full object-cover" />
                    </div>
                </div>
    ...
    >
        <div class="mx-auto max-w-3xl px-4 py-8">
            ...
            <div class="prose prose-sm max-w-none text-brand-gray prose-headings:font-heading prose-headings:text-brand-dark prose-h3:text-lg prose-h3:font-semibold prose-a:text-brand-red">
                ...
                <p>
                    Maniraj Crackers ("we", "our", "us") operates the website manirajcrackers.com.
                ...
                <p>
                    ...
                    <strong>Maniraj Crackers</strong><br>
