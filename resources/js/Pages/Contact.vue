...
<template>
    <Head title="Contact Us - Maniraj Crackers Sivakasi">
        <meta name="description" content="Contact Maniraj Crackers for wholesale crackers orders. Located in Sivakasi, Tamil Nadu. Call or WhatsApp for price list and orders. All India delivery." />
    </Head>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-sm text-brand-gray">
                                    <a v-if="company_email" :href="`mailto:${company_email}`" class="hover:text-brand-red">{{ company_email }}</a>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input
                                    ...
                                    type="text"
                                    required
                                    class="w-full rounded-lg border border-gray-200 px-4 py-2.5 text-sm text-brand-dark placeholder-gray-400 focus:border-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800/30"
