...
<template>
    <Head title="FAQ - Frequently Asked Questions | Maniraj Crackers">
    ...
    >
        ...
        <div class="bg-gradient-to-b from-red-50 to-white py-12">
            <div class="mx-auto max-w-4xl px-4">
                ...
                <p class="mb-10 text-center text-gray-500">Everything you need to know about ordering crackers from Maniraj Crackers</p>
